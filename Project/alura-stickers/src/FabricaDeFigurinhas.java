...
public class FabricaDeFigurinhas {
    ...
    public void Cria(InputStream imageSource,String legenda,String outputFileName) throws Exception {
        ...
        //Font font = new Font(impact, Font.BOLD, 160);
        graphics.setFont(comic);
        
        // Criar outline para a frase
        //graphics.setFont(graphics.getFont().deriveFont(Font.BOLD, largura * 0.16f ));// tamanho bom para topzera
        System.out.println("Largura é: "+ largura + " font size é: "+ largura * 0.16f);
        ...
        graphics.drawString(legenda, (largura/8), novaAltura - (novaAltura*0.1f)); // calcular offsets
  ...
  return scaledFont.deriveFont( (float) Math.floor( scaledPt ) );
    ...
    //     fabrica.Cria(new URL("https://raw.githubusercontent.com/alura-cursos/imersao-java-2-api/main/MostPopularMovies_3.jpg").openStream(),"figurinha2");
    // }
}
